function findTopLeft(pointList) {   //Max lat and minimum lon
    var maxLat = null;
    var minLon = null;
...
function findBottomLeft(pointList) {   //Minimum lat and minimum lon
    var minLat = null;
    var minLon = null;
    pointList.data.forEach(
        point => {
...
function findBottomRight(pointList) {   //Minimum lat and max lon
    var minLat = null;
    var maxLon = null;
    pointList.data.forEach(
        point => {
...
function Run(){
    //get the corners by creating functions which select an item from the data which has the correct value
    ...
    console.log("Bounding box computed for nledesma@tamu.edu: ");
